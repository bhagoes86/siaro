 ...
 */
$config['site_title']                 = "Arisan - danang-ekal.com";       // Site Title, example.com
$config['admin_email']                = "danangekal@gmail.com"; // Admin Email, admin@example.com
...
$config['message_start_delimiter'] = '<p class="text-yellow">'; 	// Message start delimiter
$config['message_end_delimiter']   = '</p>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<p class="text-red">';		// Error message start delimiter
