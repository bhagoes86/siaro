			...
			switch($tag['value']) {
				...
				case 'ol': {
					...
					if ($this->rtl) {
						...
						$this->lMargin += $this->listindent; //baris ini diganti oleh baris dibawah untuk menghilangkan indent pada list, pada 10/4/2014
						//$this->lMargin += $this->listindent/2;//ternyata tidak berpengaruh
					}
					++$this->listindentlevel;
					if ($this->listnum == 1) {
						$this->addHTMLVertSpace($hbz, $hb, $cell, $firstorlast);
